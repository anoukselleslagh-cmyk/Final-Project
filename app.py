...
def load_and_clean_data(data_path: str, min_ratings: int = 5):
    ...
    # This FIXES the "100% match" problem.
    # Raw cosine similarity is multiplied by a significance factor:
    #   sig = min(common_raters, THRESHOLD) / THRESHOLD
    # So two products that share only 2 common raters (out of threshold=10)
    # get their similarity multiplied by 0.2 instead of showing a fake 100%.
    ...
    # Count common raters for each product pair
